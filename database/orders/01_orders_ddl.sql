...
-- Crear base de datos
-- En PostgreSQL no existe IF NOT EXISTS para CREATE DATABASE,
-- se recomienda verificar antes con un script externo.
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    CHECK (status IN ('EN_PROCESO', 'CANCELADO', 'ENTREGADO')),
    owner_id INT NOT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT idx_owner_id FOREIGN KEY (owner_id) REFERENCES orders(id)
    );
